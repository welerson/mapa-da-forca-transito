...
import { Car, Bike, Truck, Bus, Plus, Filter, AlertTriangle, LucideIcon } from 'lucide-react';
...
const VehicleList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg flex items-start gap-3 text-left">
